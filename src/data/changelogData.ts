...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    version: '2.5.0',
    date: '2026-07-09',
    headline: 'Traffic funnel & Keyword portfolio, rebuilt on real search data',
    changes: [
      {
        type: 'improved',
        title: 'Traffic funnel tells you where you’re losing the market',
        ...
        route: { section: 'Sales', sub: 'Traffic funnel' },
      },
      {
        type: 'new',
      ...
      },
      {
        ...
        description: 'In the Traffic funnel, open any product’s top query and land directly on that keyword in the Keyword portfolio — no re-searching.',
        route: { section: 'Sales', sub: 'Keyword portfolio' },
      },
      {
        type: 'improved',
        title: 'Keyword portfolio shows which ASINs win each keyword',
