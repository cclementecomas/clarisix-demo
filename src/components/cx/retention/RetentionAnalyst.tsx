...
const subCols: ColumnDef[] = [
  ...
  { field: 'currentAcos', headerName: 'Current ACoS', width: 124, group: 'Current acquisition', valueFormatter: acosF, cellStyle: ({ value }: any): Record<string, string> => (value == null ? { color: '#9ca3af' } : {}) },
  { field: 'spend', headerName: 'Spend', width: 100, group: 'Current acquisition', valueFormatter: ({ value }: any) => (value == null ? 'Not supplied' : money(value)) },
  { field: 'payback', headerName: 'Payback', width: 98, group: 'Current acquisition', valueFormatter: ({ value }: any) => (value == null ? '—' : `${(value as number).toFixed(1)} mo`) },
